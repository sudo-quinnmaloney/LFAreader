...
Once this is done, click the green play button in the top right to run the program. This will underline the remaining packages on lines 1 through 6 that need to be installed. You can do this easily by right clicking on the library names (each will be underlined in red as an 'unresolved reference') and opting to 'import package'.
